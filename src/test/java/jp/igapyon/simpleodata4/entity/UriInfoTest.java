...
import jp.igapyon.simpleodata4.util.TinySqlExprExpandUtil;
...
class UriInfoTest {
	...
	void test01() throws Exception {
		...
		assertEquals("([ID] = 1.0)", TinySqlExprExpandUtil.expand(uriInfo.getFilterOption().getExpression()));
	}
	...
	void test02() throws Exception {
		...
		assertEquals("(([Description] = 'Mac') AND ([ID] = 2.0))",
				TinySqlExprExpandUtil.expand(uriInfo.getFilterOption().getExpression()));
	}
